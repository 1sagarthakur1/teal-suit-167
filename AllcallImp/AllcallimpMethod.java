...
//	private static final String String = null;
	...
	public static void allClassholder(){
		...
		int NoPo = crimeDao.forcountAllpolicestation();
	...
	public static void loginCallMethod() {
		...
		String string = cDao.forloginPoliceStation(PsLid, pass);
	...
	public static void policestationRagistetion() {
		...
		CrimeDao crimeDao = new CrimeDaoImplimantion();
		System.out.println();
		int psid = (crimeDao.forcountAllpolicestation())+1;
		...
		String string = crimeDao.forRagistarPS(policeStation);
		System.out.println(string);
		System.out.println();
	...
	public static void allAddCrimeAndCriminalCall(String pString) {
		...
		System.out.println();
		int crmimid = (crimeDao.forcountAllcrime())+1;
		...
		int cid = (crimeDao.forcountAllcriminal())+1;
		...
		String string = crimeDao.forAddCrimeAndCrimnal(crimes, criminal2);
		System.out.println(string);
	...
	public static void allcrimesCall(String PSLid) {
		...
		List<Crimes> list = crimeDao.forShowallCrimeList(PSLid);
		...
		if(num3==1) {
			...
			List<Crimes> list1 =crimeDao2.forshowAllSolveCrimes(solve, PSLid);
			if(list1.size()>0) {
			...
			List<Crimes> list2 = crimeDao3.forShowAllUNsolveCrimes(notSolve, PSLid);
			if(list2.size()>0) {
			...
			String geString = crimeDao4.forChangeSVNSVcrimes(soString, num7);
	...
	public static void allcriminalsCall(String PSid) {
		...
		System.out.println();
		CrimeDao crimeDao = new CrimeDaoImplimantion();
		List<CrimesAndCriminals> list = crimeDao.forShowAllCriminal(PSid);
//		System.out.println(list);
	...
	public static void allCriminalBydate(String PSLid) {
		...
		System.out.println();
		CrimeDao crimeDao = new CrimeDaoImplimantion();
		List<CrimesAndCriminals> list = crimeDao.forShowCriminalbydate(date1, date2);
		if(list.size()>0) {
			list.forEach((l) -> System.out.println(
					"Criminal Name         : "+l.getCrmNameString()+"\n"+
							"Criminal age          : "+l.getAge()+"\n"+
